...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-auto items-center justify-center rounded-xl bg-muted/50 p-1 text-muted-foreground",
...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.Trigger
    ...
    className={cn(
      ...
      "data-[state=active]:bg-white data-[state=active]:text-yellow-500 data-[state=active]:shadow-sm",
      "hover:bg-white/80 hover:text-yellow-500/80",
      "active:scale-95",
      className
    )}
    {...props}
